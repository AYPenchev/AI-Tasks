            ...
            for (int i = 0; i < matrix.GetLength(0); i++)
            {
                for (int j = 0; j < matrix.GetLength(1); j++)
                {
                    ...
                    switch (num)
                    {
                        ...
                        //case 1: this.manhatanDistance += Math.Abs(i - 0) + Math.Abs(j - 0); break;
                        //case 2: this.manhatanDistance += Math.Abs(i - 1) + Math.Abs(j - 0); break;
                        //case 3: this.manhatanDistance += Math.Abs(i - 2) + Math.Abs(j - 0); break;
                        //case 4: this.manhatanDistance += Math.Abs(i - 0) + Math.Abs(j - 1); break;
                        //case 5: this.manhatanDistance += Math.Abs(i - 1) + Math.Abs(j - 1); break;
                        //case 6: this.manhatanDistance += Math.Abs(i - 2) + Math.Abs(j - 1); break;
                        //case 7: this.manhatanDistance += Math.Abs(i - 0) + Math.Abs(j - 2); break;
                        //case 8: this.manhatanDistance += Math.Abs(i - 1) + Math.Abs(j - 2); break;
